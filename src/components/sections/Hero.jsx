    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {cursorTrail.map((point, index) => (
        <motion.div
          ...
          className="fixed w-2 h-2 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-full pointer-events-none z-50"
          style={{
            left: point.x - 4,
            top: point.y - 4,
          }}
      ...
      {particles.map((particle) => (
        <motion.div
          ...
          className="fixed w-3 h-3 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-full pointer-events-none z-50"
        />
      ))}
          ...
          <div className="flex justify-center items-center flex-wrap">
            {titleText.split('').map((letter, index) => (
              <motion.span
                ...
                className="text-6xl md:text-8xl lg:text-9xl font-bold bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent inline-block cursor-pointer"
                style={{
